...
export const STRINGS = {
    ...
    'settings.privacy.notice': 'Sähköpostiosoitteesi tallennetaan aikataulun lähetystä varten.',
    'settings.privacy.link':   'Lue tietosuojaseloste',
  ...
  en: {
    ...
    'settings.privacy.notice': 'We store your email to deliver the timetable.',
    'settings.privacy.link':   'Read the privacy policy',
