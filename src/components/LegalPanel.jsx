...
const DOCS = {
  tietosuoja: {
    ...
    sections: [
      ...
      { h: "2. Käsiteltävät tiedot", body: "Palvelu ei tallenna henkilötietoja palvelimelle. Kaikki kurssivalinnat, koulun valinta, lukuvuosi ja toivelista tallennetaan ainoastaan käyttäjän oman selaimen localStorage-muistiin avaimella \"lukkari.v1\". Tietoja ei lähetetä eteenpäin." },
      ...
      { h: "7. Evästeet", body: "Palvelu ei käytä evästeitä. Toiminnallisuuteen käytetään ainoastaan localStorage-rajapintaa, joka ei ole eväste eikä lähetä tietoa palvelimelle." },
  ...
  kayttoehdot: {
    ...
    sections: [
      ...
      { h: "4. Käyttäjän vastuu", body: "Käyttäjä on yksin vastuussa: (a) lopullisten kurssivalintojensa oikeellisuudesta omassa Wilma-järjestelmässä tai vastaavassa, (b) Pro-version sisältämän Wilma-automaatioskriptin käytöstä omalla tietokoneellaan ja Wilma-tunnuksillaan, (c) sen varmistamisesta, että automaation tekemät valinnat vastaavat käyttäjän tahtoa, ja (d) oman koulunsa kurssivalintaohjeiden ja määräaikojen noudattamisesta." },
      { h: "5. Wilma-automaatio (Pro)", body: "Wilma-automaatio on selainkonsolissa ajettava JavaScript-koodi, joka simuloi käyttäjän tekemiä klikkauksia. Koodi: (a) ei tallenna käyttäjän Wilma-tunnuksia minnekään, (b) toimii ainoastaan käyttäjän omassa selainistunnossa, (c) ei lähetä tietoja palveluntarjoajalle. Käyttäjä hyväksyy, että automaation käyttäminen voi olla vastoin Wilma-järjestelmän käyttöehtoja, ja vastaa itse seurauksista. Lukkari.io ei ole sidoksissa Visma InSchool Oy:hyn eikä Wilman tarjoajaan." },
  ...
  evasteet: {
    ...
    updated: "25.4.2026",
    sections: [
      { h: "1. Evästeitä ei käytetä", body: "Lukkari.io ei aseta tai lue evästeitä (cookies). Toiminnallisuus toteutetaan ainoastaan selaimen localStorage-rajapinnalla." },
